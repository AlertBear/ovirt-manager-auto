...
PACKAGE_DATA = {
#        PACKAGE_NAME: ['art/jasper_api/data_struct/api.xsd'],
        }

DATA_FILES = [
#        'art/tests/jasper/*/*.xml',
#        'art/tests/jasper/*/*.conf',
#        'art/jasper_api/data_struct/api.xsd',
        ]
DATA_FILES = common.expand_paths(TEST_DATA_PATH, *DATA_FILES)


SCRIPT = """\
find /opt/art/jasper_api -type f -regex '.*[.]py$' -exec sed -i 's/art[.]jasper_api/jasper_api/g' '{}' \; &>/dev/null
