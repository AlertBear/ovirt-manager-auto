...
from art.test_handler.reports import initializeLogger, DefaultResultsReporter,\
                                 JUnitResultsReporter
from art.core_api.http import HTTPProxy
from art.test_handler.settings import opts, populateOptsFromArgv, readTestRunOpts
from socket import error as SocketError
from art.test_handler.python_runner import PythonRunner
from art.test_handler.xml_runner import XmlRunner
from art.test_handler.ods_runner import OdsRunner
from art.test_handler.test_runner import CONFIG_PARAMS, ACTIONS_PATH
from art.core_api.apis_exceptions import CannotRunTests, VitalTestFailed
    ...
    def run_suite_test(self, test):
        ...
        try:
            ...
            if not os.path.exists(testFilePath):
                testFilePath = os.path.join(os.path.dirname(__file__), '..', testFilePath)
                if not os.path.exists(testFilePath):
