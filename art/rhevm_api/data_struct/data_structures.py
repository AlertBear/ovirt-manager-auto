...
class HostNIC(BaseResource):
    member_data_items_ = {
        ...
        'custom_configuration': MemberSpec_('custom_configuration', 'xs:boolean', 0),
        'override_configuration': MemberSpec_('override_configuration', 'xs:boolean', 0),
        }
    subclass = None
    superclass = BaseResource
...
class VersionCaps(Version):
    member_data_items_ = {
        ...
        'custom_properties': MemberSpec_('custom_properties', 'custom_properties', 0),
