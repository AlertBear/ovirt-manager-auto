...
CLOUD_INIT_HOST_NAME = 'cloud_init'
CLOUD_INIT_VM_DISK_NAME = 'cloud_init'
NEW_ZEALAND_TZ = "NZ"
NEW_ZEALAND_TZ_VALUE = NEW_ZEALAND_TZ + "DT"
MEXICO_TZ = "EST"
MEXICO_TZ_VALUE = "EST"
DNS_SERVER = "1.2.3.4"
DNS_SEARCH = "foo.test.com"
# cloud init check commands
CHECK_USER_IN_GUEST = 'cat /etc/passwd | grep /bin/bash  | grep -E %s'
