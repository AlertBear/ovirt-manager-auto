...
class TestCase5968(basePlan.TestCase5968):
    ...
    TODO: This case is not fit for live storage migration between mixed
    storage types, because the conversion of image from File to Block and vice
    versa, changes the image structure and it's minimum size: block smaller
    size is 1GB and file smaller size is <1GB
    """
    __test__ = False
