...
try:
    ...
    ANSIBLE_ENGINE_CA_FILE = '/etc/pki/ovirt-engine/ca.pem'
...
ENGINE_HOSTS = [
    host['name'] for host in GE['hosts']
    if host['cluster'] == ANSIBLE_ENGINE_CLUSTER_NAME
]
