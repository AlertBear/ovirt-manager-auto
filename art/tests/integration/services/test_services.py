...
class TestServicesSanity(ServicesTest):
    ...
    polarion_map = {
        ...
        'test_host_rhel_momd_running': 'RHEVM-19504',
        'test_host_rhel_momd_enabled': 'RHEVM-19505',
        'test_host_rhel_ovirt-imageio-daemon_running': 'RHEVM-19508',
        'test_host_rhel_ovirt-imageio-daemon_enabled': 'RHEVM-19509',
        'test_host_rhel_ovirt-vmconsole-host-sshd_running': 'RHEVM-1512',
        ...
        'test_host_rhvh_momd_running': 'RHEVM-19506',
        'test_host_rhvh_momd_enabled': 'RHEVM-19507',
        'test_host_rhvh_ovirt-imageio-daemon_running': 'RHEVM-19510',
        'test_host_rhvh_ovirt-imageio-daemon_enabled': 'RHEVM-19511',
        'test_host_rhvh_ovirt-vmconsole-host-sshd_running': 'RHEVM-1514',
    ...
    @pytest.mark.parametrize(
        ("machine", "service", "action"),
        [
            polarion(polarion_map[i]) and bz(bz_map[i])(arguments_dict[i])
            for i in arguments_dict.keys()
        ]
    )
