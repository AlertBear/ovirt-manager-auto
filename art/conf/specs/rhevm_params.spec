...
compatibility_version = option('3.0', '3.1', '3.2', default='3.1')
...
[STORAGE]
storage_pool=force_list(default=list('10.35.64.102', '10.35.64.106', '10.35.66.10', '10.35.64.81', '10.35.160.7', '10.35.64.21'))