...
compatibility_version = option('3.0', '3.1', '3.2', '3.3', '3.4', default='3.1')
...
vds = is_alive()
data_center_type = option('nfs', 'iscsi', 'gluster', 'posixfs_nfs', 'posixfs_gluster', 'posixfs_mixed', 'localfs', 'none', default='none')
...
[STORAGE]
storage_pool=force_list(default=list('10.35.160.108', '10.35.160.7', '10.35.161.158', '10.35.160.107'))
